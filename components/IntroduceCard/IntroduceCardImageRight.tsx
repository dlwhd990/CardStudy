...
const IntroduceCardImageRight: React.FC<{ intro: Intro }> = ({ intro }) => {
  ...
  return (
    ...
    >
      <article className={`${styles.intro_article} ${styles.article_pc}`}>
        <h3>{intro.title}</h3>
        <p>{intro.content}</p>
      </article>
...
export default IntroduceCardImageRight;
